...
|        <font size="3">&rarr; **Construction d'un graphique pas-à-pas**</font>

<br>

La **structure** de la fonction `ggplot` est donc la suivante, avec les 3 principaux éléments décrits ci-dessus : 
...
ggplot(data = iris) + 
  geom_point(mapping = aes(x = Sepal.Length, y = Petal.Length), 
             color = "blue", size = 2, alpha = 0.7, shape = 3)
```
...
+ toutes les couleurs dans R
+ toutes les shapes


--> table qui donne toutes les stats directement
--> R graph gallery
...
- file:///C:/Users/diane/Desktop/Ordi%20perso/Aide%20R/tutoriales_intro_DS-master/tt_06_ggplot2_v6.html

- file:///C:/Users/diane/Desktop/Ordi%20perso/Aide%20R/tutoriales_intro_DS-master/tt_07_Rmarkdown_v2.html#6_a%C3%BAn_m%C3%A1s_cosas

- file:///C:/Users/diane/Desktop/Ordi%20perso/Aide%20R/tutoriales_intro_DS-master/tt_08_tablas_v1.html
