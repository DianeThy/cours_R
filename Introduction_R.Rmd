...
L'**output** de ce bout de code sera le suivant (sans le '\' qui sert à échapper le chunk pour pas qu'il ne run dans le corps du texte lui-même) :
...
Tout document R Markdown est composé de 3 types de contenus :
...
- https://github.com/perezp44/tutoriales_intro_DS
